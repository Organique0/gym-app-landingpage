	...
	<div class="flex flex-col gap-10 sm:gap-14 md:gap-24 py-20 flex-1 items-center justify-center">
		<div class="flex flex-col gap-2">
			<p class="opacity-60 text-base sm:text-lg md:text-xl text-center">
				For all you questions, qualms & queries
			</p>
			<h3
				class="text-4xl sm:text-5xl md:text-6xl max-w-[1000px] mx-auto w-full font-semibold texe-center"
			>
				Frequently asked questions
			</h3>
		</div>
		<div class="fle flex-col gap-8 sm:gap-10 md:gap-14 w-full">
			{#each faqs as faq}
